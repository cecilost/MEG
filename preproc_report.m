...
epochingInformation = ['Number of epochs: ', num2str(info.nsam*info.ntri),' \n',...
    '\\\\ Epoch length in samples: ', num2str(info.sam_length*info.fs),' \n',...
    '\\\\ Epoch length in seconds: ', num2str(info.sam_length),' \n',...
    ];
